module Navesti
  ...
  class WorkflowDefinition
    ...
    #    - &block: Block that defines branches using the `on` method.
    #
    ###########################################################################
    ...
    def run(data)
      ...
      @branches.each do |attribute, branch_rules|
        pp "attribute: #{attribute.inspect}"
        pp "branch rules: #{branch_rules.inspect}"
        pp "data: #{data.inspect}"
        branch_value = data[attribute]
        pp "branch_value: #{branch_value.inspect}"
  ...
  module ExternalServices
    ...
    #
    ###########################################################################
    def self.connection(url, fmt = :json, ssl_options = {})
    ...
    #
    ###########################################################################
    def self.get(url, headers = {}, ssl_options = {}, fmt = :json)
      conn = connection(url, fmt, ssl_options)
    ...
    #
    ###########################################################################
    def self.post(url, body = {}, headers = {}, ssl_options = {}, fmt = :json)
      conn = connection(url, fmt, ssl_options)
    ...
    def self.patch(url, body = {}, headers = {}, ssl_options = {}, fmt = :json)
      conn = connection(url, fmt, ssl_options)
    ...
    def self.create_consent(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end

    def self.get_consent_details(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end

    def self.get_consent_status(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end

    def self.show_accounts(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end
    ...
    def self.show_account_transactions_details(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end
    ...
    def self.initiate_authorization(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end

    def self.retrieve_token_after_authorization_step(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end

    def self.start_bank_id_app_simulation(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end

    def self.get_access_token(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end
    ...
    ## BOC specific defs ##
    def self.get_subscription_id(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end

    def self.get_subscriptions_for_tpp_based_on_subscription_id(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end

    def self.update_subscription_details_based_on_subscription_id(data, fmt = :json)
      patch(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end
    ...
    def self.get_authorization_code(data, fmt = :json)
      get(data[:url], data[:headers], data[:ssl_options], fmt)
    end

    def self.create_sandbox(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end
    ...
    ## PayPal specific defs ##
    def self.generate_client_token(data, fmt = :json)
      post(data[:url], data[:payload], data[:headers], data[:ssl_options], fmt)
    end
